function addItem() {
    ...
    var interval;
    var datVal = Date.parse(dat.value);
    if (datVal <= Date.now()) content.style.color = "#FF0000";
    else interval = setInterval(function () {if (datVal <= Date.now()) {content.style.color = "#FF0000"; clearInterval(interval);}}, 1000);
    inp.value = "";
    delet.src = "delet.png";
